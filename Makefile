...
container:
	...
	DOCKER_BUILDKIT=0 docker build -t ghcr.io/coaigo/impact_mongodb_api:latest .
...
push:
	...
	@docker push ghcr.io/coaigo/impact_mongodb_api:latest
	@echo "Pushed: ghcr.io/coaigo/impact_mongodb_api:latest"
...
delete-package:
	...
	@gh api -X DELETE "/orgs/coaigo/packages/container/impact_mongodb_api" 2>/dev/null || true
